...
/* harmony import */ var _css_main_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../css/main.css */ "./assets/src/css/main.css");
...
var initScrollNavigation = function initScrollNavigation() {
  ...
  feedbackLink.addEventListener('click', function (event) {
    event.preventDefault();
    var section = document.querySelector('[data-section="feedback"]');
    section === null || section === void 0 ? void 0 : section.scrollIntoView({
      behavior: 'smooth',
      block: 'end',
      inline: 'nearest'
...
var initFeedbackForm = function initFeedbackForm() {
  ...
  if (form !== null) {
    var successElement = document.querySelector('#feedback-success');
    var errorElement = document.querySelector('#feedback-error');
    form.addEventListener('submit', function (event) {
      event.preventDefault();
      var formData = new FormData(form);
      axios__WEBPACK_IMPORTED_MODULE_7__["default"].post(form.getAttribute('action'), formData).then(function (response) {
...
var skillsWidth = function skillsWidth() {
